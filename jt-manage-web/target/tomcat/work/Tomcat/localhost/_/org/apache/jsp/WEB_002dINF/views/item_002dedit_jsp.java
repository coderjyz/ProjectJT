 ...
 * Generated at: 2019-11-01 13:46:08 UTC
...
public final class item_002dedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <form id=\"itemEditForm\" class=\"itemForm\" method=\"post\">\r\n");
      ...
      out.write("    $(function () {\r\n");
      out.write("        itemEditEditor = KindEditorUtil.createEditor(\"#itemEditForm [name=desc]\")\r\n");
      out.write("        var data = $(\"#itemList\").datagrid(\"getSelections\")[0];\r\n");
      out.write("        var params = {\"itemId\": data.id}\r\n");
      out.write("        $.get('/item/query/item/desc', params, function (result) {\r\n");
      out.write("            console.log(result.status);\r\n");
      out.write("            if (result.status == 200) {\r\n");
      out.write("                //console.log(\"item/desc's data:\" + result.data)\r\n");
      out.write("                //itemEditEditor指的是编辑页面里面的商品描述编辑框\r\n");
      out.write("                itemEditEditor.html(result.data);\r\n");
      out.write("            }\r\n");
      out.write("        })\r\n");
      out.write("    })\r\n");
      out.write("\r\n");
      ...
      out.write("            $.messager.alert('提示', '有必填选项没有填写!');\r\n");
      out.write("            return;\r\n");
      out.write("        }\r\n");
      out.write("        $(\"#itemEditForm [name=price]\").val($(\"#itemEditForm [name=priceView]\").val() * 100);\r\n");
      ...
      out.write("        $.post(\"/item/updateItem\", $(\"#itemEditForm\").serialize(), function (data) {\r\n");
      out.write("            if (data.status == 200) {\r\n");
      out.write("                $.messager.alert(\"提示\", \"商品修改成功!\", 'info',function () {\r\n");
